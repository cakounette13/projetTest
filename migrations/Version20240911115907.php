 ...
 */
final class Version20240911115907 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE countries (id INT AUTO_INCREMENT NOT NULL, continents_id INT NOT NULL, name VARCHAR(255) NOT NULL, nb_inhabitants INT NOT NULL, capital_city VARCHAR(255) NOT NULL, INDEX IDX_5D66EBAD298246F6 (continents_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
